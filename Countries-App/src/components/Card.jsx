...
return(
    <>
    <Link to={`/${name.common}`}>
    <div className=' bg-gray-100 dark:bg-darkBlue dark:text-white hover:gray-100 rounded-tl-lg rounded-tr-lg rounded-bl-lg rounded-br-lg w-full h-80 shadow overflow-hidden'>
